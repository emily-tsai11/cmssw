...
config.General.workArea          = "/eos/user/e/etsai/workspace/CMSSW_13_1_3/src/RecoVertex/AdaptiveVertexFinder/test"
config.General.transferOutputs   = True
config.General.instance          = "prod"

config.JobType.pluginName        = "Analysis"
config.JobType.psetName          = "modify_cfg.py"
config.JobType.inputFiles        = ["/eos/user/e/etsai/workspace/CMSSW_13_1_3/src/RecoVertex/AdaptiveVertexFinder/test/TTToHadronic_PU200_cfg.py"]
