...
with open(file_list, 'r') as f:
    ...
    while True:
        ...
        # Writing .sh file
        executable = '#!/bin/bash\n\n'
        executable += 'export CMSSW_PROJECT_SRC=/afs/cern.ch/user/e/etsai/workspace/CMSSW_12_5_0_pre2/src\n'
        ...
        executable += 'cd /afs/cern.ch/user/e/etsai/workspace/CMSSW_12_5_0_pre2/src/L1Trigger/TrackFindingTracklet/test\n' # Go the directory where you have the producer and python config file
