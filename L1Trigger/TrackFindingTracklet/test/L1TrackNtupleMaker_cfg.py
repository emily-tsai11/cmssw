...
# Use -1 to run over all events in a file
...
############################################################
# Define the track ntuple process, MyProcess is the (unsigned) PDGID
# corresponding to the process which is run
...
process.L1TrackNtuple = cms.EDAnalyzer('L1TrackNtupleMaker',
	...
	DebugMode = cms.bool(False),      # Print out lots of debug statements
