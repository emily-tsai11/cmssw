...
# with command line options: NANO --python_filename topNano_v9-1-1_2017UL_data_cfg.py --fileout file:tree.root -s NANO --data --conditions 106X_dataRun2_v35 --era Run2_2017,run2_nanoAOD_106Xv2 --eventcontent NANOAOD --datatier NANOAOD --customise_commands=process.add_(cms.Service('InitRootHandlers', EnableIMT = cms.untracked.bool(False)));process.MessageLogger.cerr.FwkReport.reportEvery=1000;process.NANOAODoutput.fakeNameForCrab=cms.untracked.bool(True) --nThreads 2 -n -1 --no_exec
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('root://cms-xrd-global.cern.ch///store/data/Run2017B/MuonEG/MINIAOD/UL2017_MiniAODv2-v1/270000/17AB9CA6-CD61-1149-B492-A487F2B570B9.root'),
...
process.NANOAODoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:2017_data.root'),
